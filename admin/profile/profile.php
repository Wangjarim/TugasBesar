                ...
                <div class="row g-2 mb-3">
                    <div class="col-12">
                        <div class="d-block bg-white rounded shadow p-3">
                            <h2>Hello Admin</h2>
                            <p>Ini adalah Dashboard untuk project website kami.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-12 col-lg-6">
                        <div class="d-block rounded shadow bg-white p-3">
                            ...
                            <h5>Admin Tugas Besar</h5> <br>
                            <p>24 Desember 2022</p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="d-block rounded shadow bg-white p-3">
                            <h5>Team 7</h5>
                            <p>1. Muhammad Farhan Akbar Muhlis</p><br>
                            <p>2. Gaizka Wisnu Prawira</p>
                        </div>
                    </div>
                </div>
